 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Junges\ACL\Http\Models\Permission user($user)
 ...
 * @mixin \Eloquent
 */
class Permission extends \Junges\ACL\Http\Models\Permission
{
